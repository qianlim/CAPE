def parse_config(argv=None):
    ...
    parser.add_argument('--cond_encoder', type=int, default=1, help='1 for condition the encoder too, 0 for not')
    parser.add_argument('--reduce_dim', type=int, default=4,
                        help='rate of reducing the channels in encoder final conv layer')
    ...
    parser.add_argument('--dataset', type=str, default='dataset_male',
